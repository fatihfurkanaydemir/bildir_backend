...
//{
//    public class PersonnelRelatedTests : IClassFixture<WebTestFixture>
//    {
...
//        public PersonnelRelatedTests(WebTestFixture factory)
//        {
...
//            response = await _client.GetAsync("/api/v1/Personnel/1");
//            response.EnsureSuccessStatusCode();
