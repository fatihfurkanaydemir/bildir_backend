...
//{
//    public class EventRelatedTests : IClassFixture<WebTestFixture>
//    {
...
//        public EventRelatedTests(WebTestFixture factory)
//        {
...
//            response = await _client.GetAsync("/api/v1/Event/1");
//            response.EnsureSuccessStatusCode();
