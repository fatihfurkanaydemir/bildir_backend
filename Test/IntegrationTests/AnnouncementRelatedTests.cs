...
//{
//    public class AnnouncementRelatedTests : IClassFixture<WebTestFixture>
//    {
...
//        public AnnouncementRelatedTests(WebTestFixture factory)
//        {
...
//        [Fact]
//        public async Task TestCheckIfAnnouncementSeededAsync()
//        {
...
//            response = await _client.GetAsync("/api/v1/Announcement/1");
//            response.EnsureSuccessStatusCode();
