...
//{
//    public class ProjectRelatedTests : IClassFixture<WebTestFixture>
//    {
...
//        public ProjectRelatedTests(WebTestFixture factory)
//        {
...
//        [Fact]
//        public async Task TestCheckIfProjectSeededAsync()
//        {
...
//            response = await _client.GetAsync("/api/v1/Project/1");
//            response.EnsureSuccessStatusCode();
