...
//{
//    public class ProductRelatedTests : IClassFixture<WebTestFixture>
//    {
...
//        public ProductRelatedTests(WebTestFixture factory)
//        {
...
//        [Fact]
//        public async Task TestCheckIfProductSeededAsync()
//        {
...
//            response = await _client.GetAsync("/api/v1/Product/1");
//            response.EnsureSuccessStatusCode();
