...
//{
//    public class AddressRelatedTests : IClassFixture<WebTestFixture>
//    {
...
//        public AddressRelatedTests(WebTestFixture factory)
//        {
...
//            response = await _client.GetAsync("/api/v1/Address/1");
//            response.EnsureSuccessStatusCode();
