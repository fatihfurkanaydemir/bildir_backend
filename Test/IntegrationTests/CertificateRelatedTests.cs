...
//{
//    public class CertificateRelatedTests : IClassFixture<WebTestFixture>
//    {
...
//        public CertificateRelatedTests(WebTestFixture factory)
//        {
...
//        [Fact]
//        public async Task TestCheckIfAddressSeededAsync()
//        {
...
//            response = await _client.GetAsync("/api/v1/Certificate/1");
//            response.EnsureSuccessStatusCode();
