...
namespace Application.Features.Events.Commands.EndEvent
{
  public class EndEventCommand : IRequest<Response<int>>
  {
    public int Id { get; set; }
    public int CommunityId { get; set; }
  }
  public class EndEventCommandHandler : IRequestHandler<EndEventCommand, Response<int>>
  {
    ...
    public EndEventCommandHandler(IEventRepositoryAsync eventRepository, ICommunityRepositoryAsync communityRepository, IStudentEventRepositoryAsync studentEventRepository, IAuthenticatedUserService authenticatedUserService, IMapper mapper)
    {
    ...
    public async Task<Response<int>> Handle(EndEventCommand request, CancellationToken cancellationToken)
    {
      ...
      eventObj.State = EventStates.Ended;
